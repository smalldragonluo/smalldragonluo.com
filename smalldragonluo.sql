...
INSERT INTO `qq_content` VALUES (270, '高考成绩出来了，学妹跑去问暗恋了很久的学长考得怎样，看着学妹羞得通红的脸，学长笑了，弹了一下学妹的脑袋深情款款地说：“小傻瓜，以后别叫我学长了。” “为……为什么？难道……”', 1, '2017-09-29 21:55:01', '0000-00-00 00:00:00');
...
-- ----------------------------
BEGIN;
INSERT INTO `qq_user` VALUES (1, 'smalldragonluo', '2017-09-29 18:50:41', '2017-10-01 15:06:44', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTLJaB4BQbt1aRSdHskbXZpzQZylQSMsxpwFs8icKQw2yEx4WRuicNghRp9kAl3M43lGxGcqh7CzC2sA/0', 'oUtcC0RzJGa2UxLH2ugbZE2QMhJ4');
COMMIT;
...
CREATE TABLE `test` (
  ...
  `desc` varchar(1024) COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `test` VALUES (1, 'tpe_opt_site_lang_edit', '1,2,3,4,5,12');
INSERT INTO `test` VALUES (2, 'tpe_opt_site_lang_edit', '7,8,9,10');
INSERT INTO `test` VALUES (3, 'aa', NULL);
INSERT INTO `test` VALUES (4, 'vb', '1,12');
COMMIT;
